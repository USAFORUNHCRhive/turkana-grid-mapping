...
""" Thiis script supports running inference over a large tile by sampling chips from it."""
import numpy as np
import rasterio
...
class TileInferenceDataset(Dataset):
    def __init__(
        ...
        Args:
            ...
            channels: Input number of channels. Default is 3.
    ...
    def __getitem__(self, idx):
        ...
        if self.windowed_sampling:
            try:
                ...
                RasterioIOError
            ) as e:  # Heere to catch weird errors that I was seeing occasionally when trying to read from COGS
